...
export class Backend implements backendInterface {
    ...
    async createPost(arg0: BlogPostInput): Promise<BlogPost> {
        if (this.processError) {
            try {
    ...
    async updatePost(arg0: bigint, arg1: BlogPostInput): Promise<BlogPost> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePost(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");

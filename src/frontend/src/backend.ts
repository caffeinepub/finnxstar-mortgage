...
import type { BlogPost as _BlogPost, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createPost(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: bigint): Promise<BlogPost> {
        if (this.processError) {
            try {
    ...
    async submitLead(arg0: string, arg1: string, arg2: string, arg3: string, arg4: bigint): Promise<boolean> {
        if (this.processError) {
            try {
